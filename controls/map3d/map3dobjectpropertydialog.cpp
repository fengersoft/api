...
void Map3dObjectPropertyDialog::setMap3dObject(Map3dObject* newMap3dObject)
{
    ...
    ui->edtModelName->setText(m_map3dObject->modelName());
    ui->edtModelScale->setValue(m_map3dObject->modelScale());
    ui->cbbModelType->setCurrentText(m_map3dObject->modelType());
    ui->cbbDirection->setCurrentText(m_map3dObject->direction());
}
...
void Map3dObjectPropertyDialog::on_btnOk_clicked()
{
    ...
    m_map3dObject->setModelType(ui->cbbModelType->currentText());
    m_map3dObject->setModelName(ui->edtModelName->text());
    m_map3dObject->setModelScale(ui->edtModelScale->value());
    m_map3dObject->setDirection(ui->cbbDirection->currentText());
    accept();
}
