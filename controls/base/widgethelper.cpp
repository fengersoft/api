...
void WidgetHelper::startMouseDown()
{
    ...
    m_clickdownPoint = m_mousedownPoint;
    m_globalMousedownPoint = m_control->cursor().pos();
    m_globalMouseMovePoint = m_globalMousedownPoint;
...
void WidgetHelper::moveLeft(int d)
{
    int x = m_itemsLeft + d;
    if (x > m_maxLeft)
    {
...
double WidgetHelper::zoomFactor() const
{
    return m_zoomFactor;
}

void WidgetHelper::setZoomFactor(double newZoomFactor)
{
    m_zoomFactor = newZoomFactor;
}

int WidgetHelper::startLeft() const
{
    return m_startLeft;
}

void WidgetHelper::setStartLeft(int newStartLeft)
{
    m_startLeft = newStartLeft;
}

int WidgetHelper::startTop() const
{
    return m_startTop;
}

void WidgetHelper::setStartTop(int newStartTop)
{
    m_startTop = newStartTop;
}

QPoint WidgetHelper::globalMousedownPoint() const
{
    return m_globalMousedownPoint;
}

void WidgetHelper::setGlobalMousedownPoint(QPoint newGlobalMousedownPoint)
{
    m_globalMousedownPoint = newGlobalMousedownPoint;
}

QPoint WidgetHelper::globalMouseMovePoint() const
{
    return m_globalMouseMovePoint;
}

void WidgetHelper::setGlobalMouseMovePoint(QPoint newGlobalMouseMovePoint)
{
    m_globalMouseMovePoint = newGlobalMouseMovePoint;
}

QPoint WidgetHelper::clickdownPoint() const
{
    return m_clickdownPoint;
}

void WidgetHelper::setClickdownPoint(QPoint newClickdownPoint)
{
    m_clickdownPoint = newClickdownPoint;
}
