...
const QString &RowData::pid() const
{
    return m_pid;
}

void RowData::setPid(const QString &newPid)
{
    m_pid = newPid;
}

const QString &RowData::id() const
{
    return m_id;
}

const QString &RowData::text() const
{
    return m_text;
}

void RowData::setText(const QString &newText)
{
    m_text = newText;
}

void RowData::setId(const QString &newId)
{
    m_id = newId;
}
