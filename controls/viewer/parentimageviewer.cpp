...
void ParentImageViewer::appendFile(QString filePath, bool bUpdate)
{
...
void ParentImageViewer::clear()
{
    qDeleteAll(images);
    images.clear();
    m_helper->setItemsTop(m_helper->maxTop());
    update();
...
void ParentImageViewer::refreshImages()
{
    recalCellIndexes();
    update();
