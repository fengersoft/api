...
QColor BaseItem::borderColor() const
{
    return m_borderColor;
}

void BaseItem::setBorderColor(const QColor &newBorderColor)
{
    m_borderColor = newBorderColor;
}

int BaseItem::fontSize() const
{
    return m_fontSize;
}

void BaseItem::setFontSize(int newFontSize)
{
